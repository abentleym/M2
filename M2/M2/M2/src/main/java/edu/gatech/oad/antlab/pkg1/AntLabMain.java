 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Joe Fahey");
		  toPrint += p1.toString("902846647");
		  ...
		  toPrint += p3.toString("gburdell3");
                  ...
                  Person4 p4 = new Person4("Alexander Meyer");
                  toPrint += p4.toString("903053756");
                  
                  Person5 p5 = new Person5("Sean Fisher");
                  toPrint += p5.toString("sfisher40");
